...
export default function Home() {
  return (
    <main>
      ...
      <footer><a href="#top" className="footer-logo"><Image src="/hivaulted-horizontal.svg" alt="HiVaulted" width={244} height={52} /></a><p>Social media support for people who would rather be doing their actual work.</p><nav><a href="#product">The product</a><a href="#how-it-works">How it works</a><a href="#demo">Demo</a><a href="#pricing">Pricing</a><a href="mailto:hello@hivaulted.com">Contact</a><a href="https://www.hivaulted.com/privacy-policy">Privacy</a><a href="https://www.hivaulted.com/terms-conditions">Terms</a></nav><div className="footer-bottom"><span>© 2026 HiVaulted™. All rights reserved.</span><span>Customized by you. Powered by thoughtful AI.</span></div></footer>
    </main>
  );
}
