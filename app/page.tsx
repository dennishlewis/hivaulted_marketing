...
export default function Home() {
  return (
    <main>
      ...
      <section className="award-section"><div className="award-logo"><Image src="/ava-gold-winner.webp" alt="2026 AVA Digital Awards Gold Winner" width={600} height={577} /></div><div><p className="eyebrow"><span /> Recognized innovation</p><h2>Built by someone who understands what busy business owners are up against.</h2><p>HiVaulted founder Anne Archer was named 2026 AI Innovator of the Year for the Minnesota/Wisconsin region of Coldwell Banker Realty.</p><small>Awarded to Anne Archer. Independent of Coldwell Banker Realty.</small></div></section>
      ...
      <footer><div className="footer-brand-row"><div><a href="#top" className="footer-logo"><Image src="/hivaulted-logo.png" alt="HiVaulted" width={1000} height={271} /></a><p>Social media support for people who would rather be doing their actual work.</p></div><div className="footer-recognition"><span>2026 Gold Winner</span><div><Image src="/ava-gold-winner.webp" alt="2026 AVA Digital Awards Gold Winner" width={600} height={577} /></div></div></div><nav><a href="#product">The product</a><a href="#how-it-works">How it works</a><a href="#demo">Demo</a><a href="#pricing">Pricing</a><a href="mailto:hello@hivaulted.com">Contact</a><a href="https://www.hivaulted.com/privacy-policy">Privacy</a><a href="https://www.hivaulted.com/terms-conditions">Terms</a></nav><div className="footer-bottom"><span>© 2026 HiVaulted™. All rights reserved.</span><span>Customized by you. Powered by thoughtful AI.</span></div></footer>
    </main>
  );
}
